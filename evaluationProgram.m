...
[repeatility3]=calculateRepeatability( feature41,feature42,R,T,depth1,depth2 );

%%%HessianLaplace
[feature51]=detector2d(image1,'HessianLaplace',1000,20,1,3);
[feature52]=detector2d(image2,'HessianLaplace',1000,20,1,4);
[repeatility4]=calculateRepeatability( feature51,feature52,R,T,depth1,depth2 );

%%%Hessian
[feature61]=detector2d(image1,'Hessian',1000,20,1,3);
[feature62]=detector2d(image2,'Hessian',1000,20,1,4);
[repeatility5]=calculateRepeatability( feature61,feature62,R,T,depth1,depth2 );
